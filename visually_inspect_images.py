...
folder_path = "/Users/judewells/Documents/dataScienceProgramming/data_for_domdet/visualise_cath_s60"
csv_file = os.path.join(folder_path, "S60_inspection_decisions.csv")
...
def get_user_decision(file_base):
    while True:
        decision = input(f"Viewing {file_base}.png. Enter your decision (1-accept, 2-reject, 0-no decision, 3-view .pse file): ")
        if decision == "3":
            ...
            print("Invalid option. Please enter 1, 2, 0, or 3.")
